...
import com.project_managment.projectManagmentSystem.request.InviteRequest;
import com.project_managment.projectManagmentSystem.response.MessageResponse;
import com.project_managment.projectManagmentSystem.service.InvitationService;
...
public class ProjectController {
    ...
    @PostMapping("/invite")
    public ResponseEntity<MessageResponse> inviteProject(@RequestHeader("Authorization") String jwt,
    ...
    public ResponseEntity<Invitation> acceptInvitationProject(@RequestHeader("Authorization") String jwt,
